...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, companyId: $companyId, sku: $sku, name: $name, unit: $unit, tax: $tax, active: $active, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, companyId, sku, name, unit, tax, active, createdAt);
...
class _$PriceListImpl implements _PriceList {
  ...
  @override
  String toString() {
    return 'PriceList(id: $id, companyId: $companyId, name: $name, currency: $currency, createdAt: $createdAt, prices: $prices)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, companyId, name, currency,
      createdAt, const DeepCollectionEquality().hash(_prices));
...
abstract class _PriceList implements PriceList {
  const factory _PriceList(
      ...
      final String currency,
      final DateTime? createdAt,
      final List<Price> prices}) = _$PriceListImpl;
...
class _$PriceImpl implements _Price {
  ...
  @override
  String toString() {
    return 'Price(id: $id, priceListId: $priceListId, productId: $productId, price: $price, product: $product)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, priceListId, productId, price, product);
...
abstract class _Price implements Price {
  const factory _Price(
      {required final String id,
      required final String priceListId,
      required final String productId,
      required final double price,
      final Product? product}) = _$PriceImpl;
